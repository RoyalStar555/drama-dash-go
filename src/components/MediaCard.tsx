...
export const MediaCard = ({ item, onClick }: Props) => {
  ...
  return (
    <button
      ...
      className="group relative flex-shrink-0 w-36 sm:w-44 md:w-48 overflow-hidden rounded-xl bg-card text-left shadow-md ring-1 ring-border/60 transition-all duration-300 hover:scale-[1.06] hover:shadow-2xl hover:shadow-primary/20 hover:ring-primary/60 hover:z-10 focus:outline-none focus:ring-2 focus:ring-ring"
